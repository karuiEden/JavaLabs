 ...
 * @since 1.6
 */
public class ConcurrentSkipListMapOG<K,V> extends AbstractMap<K,V>
     ...
     */
    public ConcurrentSkipListMapOG() {
     ...
     */
    public ConcurrentSkipListMapOG(Comparator<? super K> comparator) {
    ...
    public ConcurrentSkipListMapOG(Map<? extends K, ? extends V> m) {
        this.comparator = null;
        putAll(m);
    }
     ...
     */
    @SuppressWarnings("this-escape")
    public ConcurrentSkipListMapOG(SortedMap<K, ? extends V> m) {
     ...
     */
    public ConcurrentSkipListMapOG<K,V> clone() {
        try {
            @SuppressWarnings("unchecked")
            ConcurrentSkipListMapOG<K,V> clone =
                (ConcurrentSkipListMapOG<K,V>) super.clone();
            clone.keySet = null;
            clone.entrySet = null;
            clone.values = null;
   ...
   /**
    ...
    abstract class Iter<T> implements Iterator<T> {
        ...
        public final void remove() {
            ...
            ConcurrentSkipListMapOG.this.remove(k);
            lastReturned = null;
        }
    }
    ...
    static final class KeySet<K,V>
        ...
        public Iterator<K> iterator() {
            return (m instanceof ConcurrentSkipListMapOG)
                ? ((ConcurrentSkipListMapOG<K,V>)m).new KeyIterator()
        ...
        public Spliterator<K> spliterator() {
            return (m instanceof ConcurrentSkipListMapOG)
                ? ((ConcurrentSkipListMapOG<K,V>)m).keySpliterator()
                : ((SubMap<K,V>)m).new SubMapKeyIterator();
        }
    }
    ...
    static final class Values<K,V> extends AbstractCollection<V> {
        ...
        public Iterator<V> iterator() {
            return (m instanceof ConcurrentSkipListMapOG)
                ? ((ConcurrentSkipListMapOG<K,V>)m).new ValueIterator()
        ...
        public Spliterator<V> spliterator() {
            return (m instanceof ConcurrentSkipListMapOG)
                ? ((ConcurrentSkipListMapOG<K,V>)m).valueSpliterator()
                : ((SubMap<K,V>)m).new SubMapValueIterator();
        }

        public boolean removeIf(Predicate<? super V> filter) {
            if (filter == null) throw new NullPointerException();
            if (m instanceof ConcurrentSkipListMapOG)
                return ((ConcurrentSkipListMapOG<K,V>)m).removeValueIf(filter);
            // else use iterator
    ...
    static final class EntrySet<K,V> extends AbstractSet<Entry<K,V>> {
        ...
        public Iterator<Entry<K,V>> iterator() {
            return (m instanceof ConcurrentSkipListMapOG)
                ? ((ConcurrentSkipListMapOG<K,V>)m).new EntryIterator()
                : ((SubMap<K,V>)m).new SubMapEntryIterator();
        }
        ...
        public Spliterator<Entry<K,V>> spliterator() {
            return (m instanceof ConcurrentSkipListMapOG)
                ? ((ConcurrentSkipListMapOG<K,V>)m).entrySpliterator()
                : ((SubMap<K,V>)m).new SubMapEntryIterator();
        }
        public boolean removeIf(Predicate<? super Entry<K,V>> filter) {
            if (filter == null) throw new NullPointerException();
            if (m instanceof ConcurrentSkipListMapOG)
                return ((ConcurrentSkipListMapOG<K,V>)m).removeEntryIf(filter);
            // else use iterator
            Iterator<Entry<K,V>> it =
                ((SubMap<K,V>)m).new SubMapEntryIterator();
            boolean removed = false;
    ...
    /**
     * Submaps returned by {@link ConcurrentSkipListMapOG} submap operations
    ...
    static final class SubMap<K,V> extends AbstractMap<K,V>
        ...
        final ConcurrentSkipListMapOG<K,V> m;
         ...
         */
        SubMap(ConcurrentSkipListMapOG<K,V> map,
    ...
    static {
        try {
            ...
            HEAD = l.findVarHandle(ConcurrentSkipListMapOG.class, "head",
                                   Index.class);
            ADDER = l.findVarHandle(ConcurrentSkipListMapOG.class, "adder",
                                    LongAdder.class);
