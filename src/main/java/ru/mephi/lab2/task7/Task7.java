...
/**
 * Represents a 2D point with mutators using Cartesian coordinates (x, y). Provides methods to
 * manipulate and retrieve the coordinates of the point.
 *
 * @author karui
 * @version 0.9
 * @deprecated
...
/**
 * Represents a 2D point with accessors using Cartesian coordinates (x, y). Provides methods to
 * manipulate and retrieve the coordinates of the point.
 *
 * @author karui
 * @version 1.0
